...
___
# Quick links (4)
Here you can find links to the intro tutorial and our Discord
...
![Panel Layout](/images/layout-1.png)
![Panel Layout](/images/layout-2.png)

## Node Picker
The Node Picker opens up when you right-click on the editor canvas, allowing you to search for and add nodes to your spell quickly. It provides a convenient way to access the full range of available nodes and actions.
